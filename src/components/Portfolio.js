            ...
            <React.Fragment>
                ...
                <div className="container-fluid">
                    ...
                    <div className="row" style={portfolioItem}>
                        ...
                        <div className="col-12 col-md-7" style={{padding: '0 30px'}}>
                            ...
                            <dl className="row">
                                <dt className="col-lg-2">Description</dt>
                                <dd className="col-lg-1"></dd>
                                <dd className="col-lg-9 mb-4">Nonjudgmentally presents data and options, so you can always do the right thing.</dd>
                    ...
                    <div className="row" style={portfolioItem}>
                        ...
                        <div className="col-12 col-md-7" style={{padding: '0 30px'}}>
                            {/* header */}
                            <a href="http://show-shuffle.herokuapp.com" target="_blank" rel="noopener noreferrer" style={{color: 'black'}}>
